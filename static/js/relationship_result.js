...
function drawGraph() {
    d3.json('/static/results/twitter_friendship.json').then(function(data) {
        ...
        document.getElementById("query").textContent = searched_user + " | Level: " + level + " | Users: " + users;
        ...
        for (let i = 0; i < most_following.length; i++) {
            most_following_paragraph += most_following[i].user + "(" + most_following[i].counts + ")";
        ...
        for (let i = 0; i < most_follower.length; i++) {
            most_follower_paragraph += most_follower[i].user + "(" + most_follower[i].counts + ")";
        ...
        for (let i = 0; i < least_following.length; i++) {
            least_following_paragraph += least_following[i].user + "(" + least_following[i].counts + ")";
        ...
        for (let i = 0; i < least_follower.length; i++) {
            least_follower_paragraph += least_follower[i].user + "(" + least_follower[i].counts + ")";
        ...
        for (let i = 0; i < bottom_five.length; i++) {
            bottomFive_paragraph += bottom_five[i].user + "(" + bottom_five[i].counts + ")";
